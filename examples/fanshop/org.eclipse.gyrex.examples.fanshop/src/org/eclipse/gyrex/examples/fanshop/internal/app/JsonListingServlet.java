...
import org.eclipse.cloudfree.services.listings.query.ListingQuery.ResultDimension;
...
public class JsonListingServlet extends HttpServlet {
	...
	private void doHelp(final HttpServletRequest req, final HttpServletResponse resp) throws IOException {
		...
		writer.println("      (see JavaDoc of org.eclipse.cloudfree.services.listings.query.ListingQuery#setQuery(String))");
