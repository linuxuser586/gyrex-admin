...
public class SelectionButtonDialogFieldGroup extends DialogField {
	 ...
	 */
	public SelectionButtonDialogFieldGroup(final int buttonsStyle, final String[] buttonNames, final int nColumns) {
	...
	private Button createSelectionButton(final int index, final Composite group, final SelectionListener listener) {
