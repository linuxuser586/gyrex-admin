...
public class PatternFilter extends ViewerFilter {
	 ...
	 */
	@Override
	public final Object[] filter(final Viewer viewer, final Object parent, final Object[] elements) {
		...
		if (filtered == null) {
			final Boolean foundAny = foundAnyCache.get(parent);
	...
	private boolean isAnyVisible(final Viewer viewer, final Object parent, final Object[] elements) {
		...
		final Object[] filtered = cache.get(parent);
		if (filtered != null)
	...
	protected boolean isParentMatch(final Viewer viewer, final Object element) {
		final Object[] children = ((ITreeContentProvider) ((AbstractTreeViewer) viewer).getContentProvider()).getChildren(element);
