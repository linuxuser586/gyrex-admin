...
public class AddEditEnvironmentVariableDialog extends NonBlockingStatusDialog {
	...
	public AddEditEnvironmentVariableDialog(final Shell parent) {
		this(parent, null, null);
	}

	public AddEditEnvironmentVariableDialog(final Shell parent, final String name, final String value) {
		super(parent);
		isEdit = name != null;
		setTitle(isEdit ? "Edit Variable" : "New Variable");
