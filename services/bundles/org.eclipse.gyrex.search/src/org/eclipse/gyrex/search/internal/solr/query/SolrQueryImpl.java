...
public class SolrQueryImpl {
	 ...
	 */
	public SolrQueryImpl addFilterQuery(final String filterQuery) {
	 ...
	 */
	public SolrQueryImpl addSortField(final String fieldName, final SortDirection direction) {
	 ...
	 * which is capable of encoding strings.
	 * </p>
	 * 
	 * @param advancedQuery
	 ...
	 * @see #setQuery(String)
	 */
	public SolrQueryImpl setAdvancedQuery(final String advancedQuery) {
	 ...
	 * @see #setAdvancedQuery(String)
	 */
	public SolrQueryImpl setFilterQueries(final String... filterQueries) {
	 ...
	 */
	public SolrQueryImpl setMaxResults(final int maxResults) {
		if (maxResults < 0) {
	 ...
	 * @see #setAdvancedQuery(String)
	 */
	public SolrQueryImpl setQuery(final String query) {
		this.query = query;
		return this;
	}
	 ...
	 * @see #addSortField(String, SortDirection)
	 */
	public SolrQueryImpl setSortField(final String fieldName, final SortDirection direction) {
		sortFields.clear();
		if (StringUtils.isNotBlank(fieldName)) {
			sortFields.put(fieldName, direction);
		}
	 ...
	 * @see #setMaxResults(int)
	 */
	public SolrQueryImpl setStartIndex(final long startIndex) {
