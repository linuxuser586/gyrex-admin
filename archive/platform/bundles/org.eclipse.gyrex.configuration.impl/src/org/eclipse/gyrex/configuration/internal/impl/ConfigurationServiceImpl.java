...
public class ConfigurationServiceImpl implements IConfigurationService {
	...
	private Preferences getNode(final String qualifier, final String key, final IContext context) {
	...
	private Preferences[] getNodes(final String qualifier, final String key, final IContext context) {
	...
	private void put(final String qualifier, final String key, final String value, final IContext context, final boolean encrypt) {
