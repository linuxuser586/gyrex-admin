...
import org.eclipse.cloudfree.admin.web.gwt.app.internal.client.widgets.ContentTitleProvider;
import org.eclipse.cloudfree.admin.web.gwt.app.internal.client.widgets.Error;
import org.eclipse.cloudfree.admin.web.gwt.app.internal.services.client.services.ICloudFreeAppUIServiceAsync;
 ...
 */
public abstract class CloudFreeApp {
	...
	private void initializeOperationMode() {
		final ICloudFreeAppUIServiceAsync configurationService = ServiceRegistry.getConfigurationService();
