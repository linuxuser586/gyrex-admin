...
class ErrorPageMessages {
	...
	private static final String[] funny404Messages = new String[] {
			...
			"<p><b class=\"red\">CloudFree Admin:</b> Sir! We have reports that someone is trying to access a page that doesn\'t exist!<br>\n" + "<b class=\"blue\">CloudFree Captain:</b> Impossible! How can that be?<br>\n" + "<b class=\"red\">CloudFree Admin:</b> Sir, I don\'t know. Maybe they typed in the URL wrong or maybe we\'re suffering from a critical system failure.<br>\n"
					+ "<b class=\"blue\">CloudFree Captain:</b> Unacceptable! Redirect them to a 404 page and make it snappy!\n" + "</p>", };
